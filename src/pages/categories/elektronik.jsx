...
const elektronikPage = () =>{
  ...
  const getElektronik = useQuery({
    
    queryKey: ["elektronik-list"],
    queryFn: async () => {
      ...
      <div className="h-screen w-screen flex flex-col">
          ...
          <div className="h-screen w-screen flex flex-col bg-[#F7FFF7]">
              <div className="flex justify-center items-center">
                <div className="w-[1000px] xs:w-[450px] sm:w-[700px] lg:w-[900px] xl:w-[1000px] h-[300px] bg-[#4ECDC4] rounded-lg flex flex-col justify-center self-center items-center">
                    <span className="text-white text-center text-5xl xs:text-4xl sm:text-5xl lg:text-5xl font-bold">ELEKTRONIK</span>
                </div>
              </div>
