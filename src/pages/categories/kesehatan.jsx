...
const kesehatanPage = () =>{
  ...
  //   //  let result = await Axios.get(`http://localhost:8080/harberid/webresources/product?filterCategory=3`);
                ...
                <div className="h-screen w-screen flex flex-col">
                    <div className="flex justify-center items-center">
                      <div className="w-[1000px] h-[300px] bg-[#4ECDC4] rounded-lg flex flex-col justify-center self-center items-center">
                          <span className="text-white text-5xl font-bold">KESEHATAN</span>
                      </div>
                    </div>
